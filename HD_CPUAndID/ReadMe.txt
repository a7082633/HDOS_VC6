========================================================================
		ActiveX Control DLL : HD_CPUANDID
========================================================================

ControlWizard has created this project for your HD_CPUANDID ActiveX Control
...
that make up your HD_CPUANDID ActiveX Control DLL.
...
HD_CPUAndIDCtl.h
	This file contains the declaration of the CHD_CPUAndIDCtrl C++ class.

HD_CPUAndIDCtl.cpp
	This file contains the implementation of the CHD_CPUAndIDCtrl C++ class.

HD_CPUAndIDPpg.h
	This file contains the declaration of the CHD_CPUAndIDPropPage C++ class.

HD_CPUAndIDPpg.cpp
	This file contains the implementation of the CHD_CPUAndIDPropPage C++ class.

HD_CPUAndIDCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CHD_CPUAndIDCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file HD_CPUAndID.rc.
