========================================================================
		ActiveX Control DLL : OCX_CALL_TEST
========================================================================

ControlWizard has created this project for your OCX_CALL_TEST ActiveX Control
...
that make up your OCX_CALL_TEST ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
OCX_Call_Test control:

OCX_Call_TestCtl.h
	This file contains the declaration of the COCX_Call_TestCtrl C++ class.

OCX_Call_TestCtl.cpp
	This file contains the implementation of the COCX_Call_TestCtrl C++ class.

OCX_Call_TestPpg.h
	This file contains the declaration of the COCX_Call_TestPropPage C++ class.

OCX_Call_TestPpg.cpp
	This file contains the implementation of the COCX_Call_TestPropPage C++ class.

OCX_Call_TestCtl.bmp
	This file contains a bitmap that a container will use to represent the
	COCX_Call_TestCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file OCX_Call_Test.rc.
