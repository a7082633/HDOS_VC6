========================================================================
		ActiveX Control DLL : OCXTEST2
========================================================================

ControlWizard has created this project for your OCXTEST2 ActiveX Control
...
that make up your OCXTEST2 ActiveX Control DLL.
...
OCXTest2Ctl.h
	This file contains the declaration of the COCXTest2Ctrl C++ class.

OCXTest2Ctl.cpp
	This file contains the implementation of the COCXTest2Ctrl C++ class.

OCXTest2Ppg.h
	This file contains the declaration of the COCXTest2PropPage C++ class.

OCXTest2Ppg.cpp
	This file contains the implementation of the COCXTest2PropPage C++ class.

OCXTest2Ctl.bmp
	This file contains a bitmap that a container will use to represent the
	COCXTest2Ctrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file OCXTest2.rc.
