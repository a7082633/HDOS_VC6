...
#pragma comment(lib, "HDCardDev.lib")
...
CHDCardDevDemoDlg::CHDCardDevDemoDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CHDCardDevDemoDlg::IDD, pParent)
	, m_strbuf(_T(""))
	, m_key(0x60)
{
...
void CHDCardDevDemoDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CHDCardDevDemoDlg, CDialog)
#if defined(_DEVICE_RESOLUTION_AWARE) && !defined(WIN32_PLATFORM_WFSP)
	ON_WM_SIZE()
#endif
	//}}AFX_MSG_MAP
	ON_BN_CLICKED(IDC_BTN_READ, &CHDCardDevDemoDlg::OnBnClickedBtnRead)
	ON_BN_CLICKED(IDC_BTN_OPEN, &CHDCardDevDemoDlg::OnBnClickedBtnOpen)
	ON_BN_CLICKED(IDC_BTN_CLOSE, &CHDCardDevDemoDlg::OnBnClickedBtnClose)
	ON_BN_CLICKED(IDC_BTN_WRITE, &CHDCardDevDemoDlg::OnBnClickedBtnWrite)
	ON_BN_CLICKED(IDC_BTN_ACTIVE, &CHDCardDevDemoDlg::OnBnClickedBtnActive)
	ON_BN_CLICKED(IDC_BTN_AUTH, &CHDCardDevDemoDlg::OnBnClickedBtnAuth)
	ON_BN_CLICKED(IDC_BTN_CERT, &CHDCardDevDemoDlg::OnBnClickedBtnCert)
	ON_BN_CLICKED(IDC_RADIO1, &CHDCardDevDemoDlg::OnBnClickedRadio1)
	ON_BN_CLICKED(IDC_RADIO2, &CHDCardDevDemoDlg::OnBnClickedRadio2)
END_MESSAGE_MAP()


// CHDCardDevDemoDlg 消息处理程序

BOOL CHDCardDevDemoDlg::OnInitDialog()
{
...
#if defined(_DEVICE_RESOLUTION_AWARE) && !defined(WIN32_PLATFORM_WFSP)
void CHDCardDevDemoDlg::OnSize(UINT /*nType*/, int /*cx*/, int /*cy*/)
{
	if (AfxIsDRAEnabled())
	{
		DRA::RelayoutDialog(
			...
			MAKEINTRESOURCE(IDD_HDCARDDEVDEMO_DIALOG_WIDE) : 
			MAKEINTRESOURCE(IDD_HDCARDDEVDEMO_DIALOG));
	}
}
#endif


void CHDCardDevDemoDlg::OnBnClickedBtnRead()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CHDCardDevDemoDlg::OnBnClickedBtnOpen()
{
	// TODO: 在此添加控件通知处理程序代码
	CComboBox *pCmbComNo = (CComboBox*)GetDlgItem(IDC_CMB_COM_NO);
...
void CHDCardDevDemoDlg::OnBnClickedBtnClose()
{
	// TODO: 在此添加控件通知处理程序代码
	long ren = hd_Close();
	if(ren)
...
void CHDCardDevDemoDlg::OnBnClickedBtnWrite()
{
	// TODO: 在此添加控件通知处理程序代码
	unsigned char data[20] = {0};
	char databuf[20] = {0};
...
void CHDCardDevDemoDlg::OnBnClickedBtnActive()
{
		// TODO: 在此添加控件通知处理程序代码
    TCHAR uid[41] = {0};
	CString temp;
...
void CHDCardDevDemoDlg::OnBnClickedBtnAuth()
{
	// TODO: 在此添加控件通知处理程序代码
	CString str, temp;
	char databuf[20] = {0};
...
void CHDCardDevDemoDlg::OnBnClickedBtnCert()
{
	// TODO: 在此添加控件通知处理程序代码
	TCHAR pName[200] = {0};
	TCHAR pSex[50] = {0};
...
void CHDCardDevDemoDlg::OnBnClickedRadio1()
{
	// TODO: 在此添加控件通知处理程序代码
	m_key = 0x60;
}

void CHDCardDevDemoDlg::OnBnClickedRadio2()
{
	// TODO: 在此添加控件通知处理程序代码
	m_key = 0x61;
}
