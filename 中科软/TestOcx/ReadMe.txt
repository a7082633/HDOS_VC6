========================================================================
		ActiveX Control DLL : TESTOCX
========================================================================

ControlWizard has created this project for your TESTOCX ActiveX Control
...
that make up your TESTOCX ActiveX Control DLL.
...
TestOcxCtl.h
	This file contains the declaration of the CTestOcxCtrl C++ class.

TestOcxCtl.cpp
	This file contains the implementation of the CTestOcxCtrl C++ class.

TestOcxPpg.h
	This file contains the declaration of the CTestOcxPropPage C++ class.

TestOcxPpg.cpp
	This file contains the implementation of the CTestOcxPropPage C++ class.

TestOcxCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CTestOcxCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file TestOcx.rc.
