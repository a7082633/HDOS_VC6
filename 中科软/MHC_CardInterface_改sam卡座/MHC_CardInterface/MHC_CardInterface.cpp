														 ...
														 char* info)
{
	...
	int ret = rd.PSAM_Reset(SLOT_USER,resp);
	if (ret != IRV_OK)
		return IRV_PSAM_ERR;
	...
	//sam改成大卡座 0x88
	//SLOT_PSAM
	ret = SelectFile (0x88  , "3F00" , NULL, NULL);
	if (ret != IRV_OK)
		return IRV_PSAM_ERR;
	//::MessageBox(NULL,"选3f00成功",NULL,MB_OK);

	ret = SelectFile (0x88  , "0015" , NULL, NULL);
	if (ret != IRV_OK)
		return IRV_PSAM_ERR;
	//::MessageBox(NULL,"选0015成功",NULL,MB_OK);

	strcpy(apdu  , "00B000000E");
	ret = rd.PSAM_Send2(apdu , resp , sw);
	if (strcmp(sw , "9000") != 0)
		return IRV_PSAM_ERR;
	//::MessageBox(NULL,"读记录成功",NULL,MB_OK);
	strcpy(info , resp);
														   ...
														   char* info)
{
	...
	ret = SelectFile (0x88  , "0016" , NULL, NULL);
	if (ret != IRV_OK)
		return IRV_PSAM_ERR;
															 ...
															 char* info)
{
	...
	//PSAM 
	ret = SelectFile (0x88  , "DF01" , NULL, NULL);
	if (ret != IRV_OK)
		return IRV_PSAM_ERR;

	ret = SelectFile (0x88  , "001A" , NULL, NULL);
	if (ret != IRV_OK)
		return IRV_PSAM_ERR;
															 ...
															 char* info)
{
	...
	ret = SelectFile (0x88  , "001B" , NULL, NULL);
	if (ret != IRV_OK)
		return IRV_PSAM_ERR;
															 ...
															 char* info)
{
	...
	ret = SelectFile (0x88  , "001C" , NULL, NULL);
	if (ret != IRV_OK)
		return IRV_PSAM_ERR;
