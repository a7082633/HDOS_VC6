========================================================================
		ActiveX Control DLL : OCXTESTBTN
========================================================================

ControlWizard has created this project for your OCXTESTBTN ActiveX Control
...
that make up your OCXTESTBTN ActiveX Control DLL.
...
OCXTestBTNCtl.h
	This file contains the declaration of the COCXTestBTNCtrl C++ class.

OCXTestBTNCtl.cpp
	This file contains the implementation of the COCXTestBTNCtrl C++ class.

OCXTestBTNPpg.h
	This file contains the declaration of the COCXTestBTNPropPage C++ class.

OCXTestBTNPpg.cpp
	This file contains the implementation of the COCXTestBTNPropPage C++ class.

OCXTestBTNCtl.bmp
	This file contains a bitmap that a container will use to represent the
	COCXTestBTNCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file OCXTestBTN.rc.
