========================================================================
		ActiveX Control DLL : HD_HNOCX
========================================================================

ControlWizard has created this project for your HD_HNOCX ActiveX Control
...
that make up your HD_HNOCX ActiveX Control DLL.
...
HD_HNOCXCtl.h
	This file contains the declaration of the CHD_HNOCXCtrl C++ class.

HD_HNOCXCtl.cpp
	This file contains the implementation of the CHD_HNOCXCtrl C++ class.

HD_HNOCXPpg.h
	This file contains the declaration of the CHD_HNOCXPropPage C++ class.

HD_HNOCXPpg.cpp
	This file contains the implementation of the CHD_HNOCXPropPage C++ class.

HD_HNOCXCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CHD_HNOCXCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file HD_HNOCX.rc.
