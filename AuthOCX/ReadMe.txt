========================================================================
		ActiveX Control DLL : AUTHOCX
========================================================================

ControlWizard has created this project for your AUTHOCX ActiveX Control
...
that make up your AUTHOCX ActiveX Control DLL.
...
AuthOCXCtl.h
	This file contains the declaration of the CAuthOCXCtrl C++ class.

AuthOCXCtl.cpp
	This file contains the implementation of the CAuthOCXCtrl C++ class.

AuthOCXPpg.h
	This file contains the declaration of the CAuthOCXPropPage C++ class.

AuthOCXPpg.cpp
	This file contains the implementation of the CAuthOCXPropPage C++ class.

AuthOCXCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CAuthOCXCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file AuthOCX.rc.
