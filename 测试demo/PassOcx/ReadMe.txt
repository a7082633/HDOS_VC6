========================================================================
		ActiveX Control DLL : PASSOCX
========================================================================

ControlWizard has created this project for your PASSOCX ActiveX Control
...
that make up your PASSOCX ActiveX Control DLL.
...
PassOcxCtl.h
	This file contains the declaration of the CPassOcxCtrl C++ class.

PassOcxCtl.cpp
	This file contains the implementation of the CPassOcxCtrl C++ class.

PassOcxPpg.h
	This file contains the declaration of the CPassOcxPropPage C++ class.

PassOcxPpg.cpp
	This file contains the implementation of the CPassOcxPropPage C++ class.

PassOcxCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CPassOcxCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file PassOcx.rc.
