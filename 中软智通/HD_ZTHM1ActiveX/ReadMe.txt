========================================================================
		ActiveX Control DLL : HD_ZTHM1ACTIVEX
========================================================================

ControlWizard has created this project for your HD_ZTHM1ACTIVEX ActiveX Control
...
that make up your HD_ZTHM1ACTIVEX ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
HD_ZTHM1ActiveX control:

HD_ZTHM1ActiveXCtl.h
	This file contains the declaration of the CHD_ZTHM1ActiveXCtrl C++ class.

HD_ZTHM1ActiveXCtl.cpp
	This file contains the implementation of the CHD_ZTHM1ActiveXCtrl C++ class.

HD_ZTHM1ActiveXPpg.h
	This file contains the declaration of the CHD_ZTHM1ActiveXPropPage C++ class.

HD_ZTHM1ActiveXPpg.cpp
	This file contains the implementation of the CHD_ZTHM1ActiveXPropPage C++ class.

HD_ZTHM1ActiveXCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CHD_ZTHM1ActiveXCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file HD_ZTHM1ActiveX.rc.
