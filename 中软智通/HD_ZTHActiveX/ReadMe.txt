========================================================================
		ActiveX Control DLL : HD_ZTHACTIVEX
========================================================================

ControlWizard has created this project for your HD_ZTHACTIVEX ActiveX Control
...
that make up your HD_ZTHACTIVEX ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
HD_ZTHActiveX control:

HD_ZTHActiveXCtl.h
	This file contains the declaration of the CHD_ZTHActiveXCtrl C++ class.

HD_ZTHActiveXCtl.cpp
	This file contains the implementation of the CHD_ZTHActiveXCtrl C++ class.

HD_ZTHActiveXPpg.h
	This file contains the declaration of the CHD_ZTHActiveXPropPage C++ class.

HD_ZTHActiveXPpg.cpp
	This file contains the implementation of the CHD_ZTHActiveXPropPage C++ class.

HD_ZTHActiveXCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CHD_ZTHActiveXCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file HD_ZTHActiveX.rc.
