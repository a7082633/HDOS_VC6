========================================================================
		ActiveX Control DLL : HD_XJOCX
========================================================================

ControlWizard has created this project for your HD_XJOCX ActiveX Control
...
that make up your HD_XJOCX ActiveX Control DLL.
...
HD_XJOCXCtl.h
	This file contains the declaration of the CHD_XJOCXCtrl C++ class.

HD_XJOCXCtl.cpp
	This file contains the implementation of the CHD_XJOCXCtrl C++ class.

HD_XJOCXPpg.h
	This file contains the declaration of the CHD_XJOCXPropPage C++ class.

HD_XJOCXPpg.cpp
	This file contains the implementation of the CHD_XJOCXPropPage C++ class.

HD_XJOCXCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CHD_XJOCXCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file HD_XJOCX.rc.
